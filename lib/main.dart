...
import 'examples/bottom_model_sheet_example.dart';

class Routes {
  /// Use [GroupButtonExtendedExample]
  /// to check all package [GroupingType]'s in one place
  static const BottomModelSheetExample = '/BottomModelSheetExample';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder> {
        Routes.BottomModelSheetExample:(_) => const BottomModelSheetExample(),
      },
      home: const BottomModelSheetExample(),
    );
  }
}
